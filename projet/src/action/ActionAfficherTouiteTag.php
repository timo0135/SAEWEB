...
class ActionAfficherTouiteTag extends Action
{
    ...
    {
        $res="";
        $sql="SELECT * FROM Touite INNER JOIN User ON User.id_user = Touite.id_user JOIN Touite2tag ON touite2tag.id_touite = Touite.id_touite JOIN Tag ON Tag.id_tag = touite2tag.id_tag WHERE tag.label=?";
